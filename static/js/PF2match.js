...
function leave_match(){
    ...
    if(confirm(prompt_text)){
        window.location.href = "mratx.github.io/PF2index.html"
    }
}
// RADIOS ----------------------------------------------------------
// Base Function
...
function match_params_radios(match_vars){
    render_radios(match_vars.radios["nplayers"])
    render_radios(match_vars.radios["npoke"])
    render_radios(match_vars.radios["weight_class"])
